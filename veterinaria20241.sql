...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-03-2024 a las 06:38:50
...
(1645688400, 1, 1234567890, 'fiebre', 'temperatura alta', 'inyeccion', 'paracetamol', 1, 'rabia', 'ninguna', 'se le aplico una inyeccion', 'fiebre', '1', 0),
(2313464735, 3, 1234567890, 'fiebre', 'temperatura alta', 'inyeccion', 'paracetamol', 3, 'rabia', 'ninguna', 'se le aplico una inyeccion', 'fiebre', '1', 0),
(3280283123, 4, 1234567890, 'fiebre', 'temperatura alta', 'inyeccion', 'paracetamol', 4, 'rabia', 'ninguna', 'se le aplico una inyeccion', 'fiebre', '1', 0),
(6823243240, 5, 1234567890, 'fiebre', 'temperatura alta', 'inyeccion', 'paracetamol', 5, 'rabia', 'ninguna', 'se le aplico una inyeccion', 'fiebre', '1', 0),
(8432123432, 2, 1234567890, 'fiebre', 'temperatura alta', 'inyeccion', 'paracetamol', 2, 'rabia', 'ninguna', 'se le aplico una inyeccion', 'fiebre', '1', 0);
...
INSERT INTO `mascota` (`id`, `propietario`, `nombre`, `edad`, `raza`, `especie`, `peso`, `caracteristicas`) VALUES
(1, 123456789, 'firulais', 5, 'labrador', 'perro', 5, 'es muy jugueton'),
(2, 123456789, 'michi', 3, 'siames', 'gato', 3, 'es muy cariñoso'),
(3, 123456789, 'pulga', 1, 'chihuahua', 'perro', 1, 'es muy pequeño'),
(4, 123456789, 'michi', 3, 'siames', 'gato', 3, 'es muy cariñoso'),
(5, 123456789, 'pulga', 1, 'chihuahua', 'perro', 1, 'es muy pequeño');
...
(123456789, 'admin', 20, 'admin', 'admin', 'admin'),
(1001588078, 'David', 20, 'CLIENT', '', ''),
(1234567890, 'veterinario', 20, 'cliente', 'veterinario', 'veterinario'),
(1234567891, 'cliente', 20, 'cliente', 'cliente', 'cliente');
